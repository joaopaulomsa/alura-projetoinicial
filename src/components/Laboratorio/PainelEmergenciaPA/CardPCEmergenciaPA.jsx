...
import { cortaString, retornaPrioridadeUx, retornaStatusUx} from '../../../helpers/useStringUtils';
...
const CardPCEmergenciaPA = (dados) => {
    ...
    if(dadosAtendimentoExames === undefined || (dadosAtendimentoExames.imagem === null && dadosAtendimentoExames.rx === null && dadosAtendimentoExames.laboratorio === null)) return( <div className={"p-1 cardExame col-12 col-sm-2"}> 
                        ...
                        <ToastHeader className="p-1" style={stylePage.toast}>
                            <Row>
                                ...
                                <Col xs={9} className="p-0">
                                    <h5>{cortaString(dadosAtendimento.paciente,25)}</h5>
                                </Col>
                                <Col xs={1}>
                            ...
                            <Row>
                                ...
                                <Col xs={7} className="p-0">
                                    <h5>{cortaString(dadosAtendimento.medico,18)}</h5>
                                </Col>
                                <Col xs={1} className="pr-1" hidden={dadosAtendimentoExames.uxInfo.orderItem !== 9999}>
    ...
    return (
        <div onClick={()=>{dados.abreModal(dadosAtendimento)}} hidden={dadosAtendimentoExames.laboratorio === null && dadosAtendimentoExames.rx === null && dadosAtendimentoExames.imagem === null} className={"p-1 cardExame pc col-12 col-sm-2"}>
                <div className={"m-0 rounded p-1 bg-"+((dadosAtendimento.ie_restricao === 'S')?'dark':dadosAtendimentoExames.uxInfo.cssStatus)}>
                    ...
                    <Col xs={12} className="p-0 h-100 lenteInfo">
                        <Lottie options={defaultOptions.Information} height={70}
                        width={70}
                        isStopped={false}
                        isClickToPauseDisabled={true}
                        isPaused={false}
